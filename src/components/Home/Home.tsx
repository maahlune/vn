    ...
    <div className="min-h-screen bg-neutral-900">
      ...
      <section className="relative h-[90vh] flex items-center overflow-hidden">
            ...
            <div className="grid md:grid-cols-5 gap-8 items-center">
              ...
              <div className="md:col-span-3 text-left">
                ...
                <p className="text-xl mb-8 font-light text-neutral-200 leading-relaxed">
                  Histórias interativas com múltiplos finais, <br /> personagens
                  memoráveis e escolhas que importam, <br /> agora disponíveis
                  em seu idioma.
                </p>
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 flex flex-col items-center animate-bounce">
          <p className="text-neutral-400 text-sm mb-2">Explorar</p>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-12">
              <h2 className="text-3xl font-bold text-white font-serif inline-block relative">
                Sobre o Projeto
              ...
              <div className="h-[450px] space-y-8 bg-neutral-800/80 backdrop-blur-md p-8 rounded-lg shadow-lg border border-neutral-700">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-300 leading-relaxed">
                      O MaahLune VN nasceu da paixão por visual novels e do
                      desejo de tornar essas experiências únicas acessíveis para
                      a comunidade brasileira. Centralizamos e organizamos as
                      melhores traduções feitas por fãs, facilitando o acesso a
                      histórias incríveis.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-neutral-300 leading-relaxed">
                      Valorizamos o trabalho árduo dos tradutores voluntários e
                      queremos dar visibilidade aos seus projetos. Aqui, cada
                      tradução é tratada com respeito e reconhecimento merecido.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="space-y-6">
                  <div className="border-l-2 border-purple-500/30 pl-4">
                    ...
                    <p className="text-neutral-400 text-sm">
                      Histórias complexas e envolventes que exploram temas
                      únicos
                    </p>
                  </div>
          ...
          <div className="max-w-7xl mx-auto">
            <div className="text-center mb-12">
              ...
              <p className="text-neutral-400 mt-4 max-w-2xl mx-auto">
                Conheça algumas das nossas melhores traduções disponíveis para
                você experimentar
              </p>
            </div>
