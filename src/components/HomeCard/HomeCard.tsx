  ...
  return (
    <div className="group bg-neutral-800/80 backdrop-blur-md rounded-xl overflow-hidden hover:shadow-2xl transition-all duration-300 border border-neutral-700 flex flex-col h-full relative">
      ...
      >
        ...
        <span
          className={`absolute top-3 right-3 px-2.5 py-1 text-xs font-medium rounded-full whitespace-nowrap ${getStatusColor()} shadow-lg`}
        >
      ...
      <div className="p-5 flex-grow flex flex-col relative z-10">
        {/* Title */}
        <h3 className="text-xl font-bold text-white font-serif mb-3 line-clamp-2">
          {title}
        </h3>

        {/* Description */}
        <p className="text-neutral-300 mb-4 line-clamp-2 text-sm">
          {description}
        </p>
