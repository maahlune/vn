...
export const translations: Translation[] = [
    ...
    {
        title: "Chaos;Child",
        image: "https://cdn.cloudflare.steamstatic.com/steam/apps/970570/header.jpg",
        description:
            "Chaos;Child é uma visual novel de terror psicológico que segue a história de Takumi Nishijo, um jovem que começa a ter alucinações e se vê envolvido em uma série de assassinatos misteriosos.",
        status: "in-progress",
        translator: "VNX+",
        genres: ["Terror", "Mistério", "Ficção Científica"],
        platforms: ["Steam"],
        downloadLink: "https://vnx.uvnworks.com/chaos-child/",
    },
    {
