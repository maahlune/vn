        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            ...
            <div className="bg-neutral-800/40 backdrop-blur-md p-6 rounded-xl border border-neutral-700 shadow-xl">
              <h3 className="text-xl font-bold font-serif mb-4 text-white inline-block relative">
                MaahLune VN
                <span className="absolute left-0 bottom-0 w-12 h-0.5 bg-purple-500"></span>
              </h3>
              <p className="text-neutral-300 mb-6 leading-relaxed">
                Centralizando as melhores traduções de Visual Novels feitas por
                fãs brasileiros para toda a comunidade.
              </p>
            ...
            <div className="bg-neutral-800/40 backdrop-blur-md p-6 rounded-xl border border-neutral-700 shadow-xl">
              ...
              <p className="text-neutral-300 mb-6 leading-relaxed">
                Ajude a manter este projeto vivo e apoie o trabalho dos
                tradutores que dedicam seu tempo para trazer essas histórias até
                você.
              </p>
              <a
                href="#"
          ...
          <div className="border-t border-neutral-800 mt-10 pt-8 text-center">
            <p className="text-neutral-300">
              © {new Date().getFullYear()} MaahLune VN - Todas as traduções
              pertencem aos seus respectivos tradutores
            </p>
            <p className="text-neutral-400 text-sm mt-3">
              Feito com <span className="text-pink-500">❤️</span> para a
              comunidade brasileira de Visual Novels
            </p>
          </div>
        </div>
      </footer>
